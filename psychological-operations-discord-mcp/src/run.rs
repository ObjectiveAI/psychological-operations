...
//! JSON-object header — see [`crate::discord_api::session`] for the
...
use crate::discord_api::session::SessionRegistry;
...
pub async fn setup(
    ...
    let service: StreamableHttpService<PsychologicalOperationsDiscordMcp, HeaderSessionManager> =
