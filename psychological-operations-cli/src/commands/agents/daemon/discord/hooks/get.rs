//! `agents daemon discord hooks get` — show one hook's full typed definition
//! (name + description + the `Hook` enum body).

use psychological_operations_sdk::cli::hooks::Hook;
use psychological_operations_sdk::cli::output::DiscordHookFull;
